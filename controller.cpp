 ...
 * Session have time,quota,bandwidth as well as other timers.
 * Note quota is managed here rather than in IPTables so we know how much is used.
 * see QuotaBeacon hack getting update from IPTables.
 */
